(ns cmr.service.bridge.app.routes.rest.core
  (:require
   [cmr.service.bridge.app.routes.rest.v1 :as v1]
   [cmr.service.bridge.app.routes.rest.v2 :as v2]
   [cmr.service.bridge.app.routes.rest.v2-1 :as v2-1]
