(ns cmr.service.bridge.site.static
...
(logger/set-level! '[cmr.service.bridge] :info)
...
(defn generate-rest-api-docs
  "Generate the HTML for the CMR Service-Bridge REST API docs page."
  [docs-source docs-dir base-url]
  (generate
   (format "%s/index.html" docs-dir)
   "templates/service-bridge-docs-static.html"
   {:base-url base-url
