(ns cmr.service.bridge.app.routes.rest.v2-1
  ...
  (:require
   [cmr.service.bridge.app.handler.collection :as collection-handler]
   [cmr.service.bridge.app.routes.rest.v1 :as routes-v1]
   [cmr.service.bridge.app.routes.rest.v2 :as routes-v2]
