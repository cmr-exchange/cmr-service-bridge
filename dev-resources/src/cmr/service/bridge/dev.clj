(ns cmr.service.bridge.dev
  "CMR Service-Bridge development namespace."
  (:require
   ...
   [cmr.service.bridge.testing.util :as testing-util]
...
(def setup-options {
  :init 'cmr.service.bridge.components.core/init
  :after-refresh 'cmr.service.bridge.dev/init-and-startup
  :throw-errors false})
