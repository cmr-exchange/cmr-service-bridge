(ns cmr.service.bridge.components.config
  (:require
   ...
   [cmr.service.bridge.config :as config-lib]
...
(def service-bridge-base-url ous-config/service-bridge-base-url)
(def service-bridge-url ous-config/service-bridge-url)
(def get-edsc-endpoint ous-config/get-edsc-endpoint)
(def get-giovanni-endpoint ous-config/get-giovanni-endpoint)
(def get-service-bridge-url ous-config/get-service-bridge-url)
